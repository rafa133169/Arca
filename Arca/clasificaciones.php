...
<body>
    ...
    <main>
        ...
        <!-- ========== Start formulario ========== -->
        <form action="insert/registro_clasificacion.php" method="post">
            <div class="mb-3">
                <label class="form-label">Ingresa una clasificacion</label>
                <input name="nombre_clasificacion2" type="text" class="form-control" required>
            </div>
            <button type="submit" class="btn btn-primary">Añadir Clasificacion</button>
        </form>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                $c = 1;
                $consulta = "SELECT id_clasificacion, nombre_clasificacion AS Clasificacion, COUNT(id_animal) AS contador FROM animal  RIGHT JOIN 
                	clasificacion ON animal.id_clasificacion_id = clasificacion.id_clasificacion GROUP BY id_clasificacion";
